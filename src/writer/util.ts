  ...
  (
    ...
    (combined, arr1value, index) => (
      ...
      ? [
        ...combined,
        ...(
          flipOrder ? [arr2[index], arr1value] : [arr1value, arr2[index]]
        ),
      ]
      : [...combined, arr1value],
    [] as Array<T | Y>,
...
export const findLastIndex = <T>(predicate : (
  value : T,
  index : number,
  obj : T[],
) => boolean,) => (arr : ReadonlyArray<T>) => {
...
export const last = <T>(array : Array<T>) : T | undefined => array.slice().reverse()[0]